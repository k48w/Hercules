...
namespace Hercules.RobloxInterfaces
{
    public static class Deployment
    {
        ...
        static Deployment()
        {
            SharedHttp.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "HerculesUpdater/2.0");
            ...
            DownloadForModGenerator(bool overwrite = false)
        {
            ...
            string tmp = Path.Combine(Path.GetTempPath(), "Hercules");
