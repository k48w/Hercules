...
using Strings = Hercules.Resources.Strings;
...
using Hercules.UI.Elements.Bootstrapper.Base;
using Hercules.UI.ViewModels.Settings;
using static Hercules.UI.ViewModels.Settings.ModsViewModel;
...
namespace Hercules
{
    public class Bootstrapper
    {
        ...
        public async Task Run()
        {
            ...
            try
            {
                using (Mutex.OpenExisting("Hercules-Bootstrapper"))
                {
                    App.Logger.WriteLine(LOG_IDENT, "Hercules-Bootstrapper mutex exists, waiting...");
            ...
            await using var mutex = new AsyncMutex(false, "Hercules-Bootstrapper");
