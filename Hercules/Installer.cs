...
namespace Hercules
{
    internal class Installer
    {
        ...
        public bool HerculesRPCReal = true;
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "1.0.3.6") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "Hercules");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\Hercules", false);
...
#pragma warning disable CS0162 // Unreachable code detected
                if (OpenReleaseNotes)
                    Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-Hercules-v{currentVer}");
