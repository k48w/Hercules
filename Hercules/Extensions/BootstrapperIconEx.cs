    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconHercules;
            }

            return icon switch
            {
                BootstrapperIcon.IconHercules => Properties.Resources.IconHercules,
                ...
                _ => Properties.Resources.IconHercules
            };
        }
    }
}
