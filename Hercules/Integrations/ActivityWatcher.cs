...
using static Hercules.Models.Persistable.AppSettings;

namespace Hercules.Integrations
{
    public class ActivityWatcher : IDisposable
    {
        private const string GameMessageEntry = "[FLog::Output] [HerculesRPC]";
        ...
        private const string GameMessageEntryPattern = @"\[HerculesRPC\] (.*)";
