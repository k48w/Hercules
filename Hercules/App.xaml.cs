...
namespace Hercules
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Hercules-QA";
#else
        public const string ProjectName = "Hercules";
#endif
        ...
        public static void AssertWindowsOSVersion()
        {
            ...
            if (!OperatingSystem.IsWindowsVersionAtLeast(10, 0, 17763))
            {
                ...
                if (!LaunchSettings.QuietFlag.Active)
                    Frontend.ShowMessageBox("Your Windows Version is not supported with Hercules!", MessageBoxImage.Error);
