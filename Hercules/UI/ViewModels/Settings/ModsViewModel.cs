...
using static Hercules.UI.Elements.Settings.Pages.ModsPage;
...
namespace Hercules.UI.ViewModels.Settings
{
    public class ModsViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public async Task LoadModsAsync() // was working on this but idk fuc
        {
            ...
            http.DefaultRequestHeaders.UserAgent.ParseAdd("HerculesApp");
        ...
        {
            _http.DefaultRequestHeaders.UserAgent.ParseAdd("HerculesSkyboxClient");
    ...
    GetVisibility(Path.Combine(Paths.Mods, "Content", "textures", "Cursors", "KeyboardMouse"),
        ...
        private readonly string _dir =
            Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Hercules");
        ...
        private void ExtractZipToDirectory(string zipFilePath, string extractPath)
        {
            ...
            while ((entry = zipInputStream.GetNextEntry()) != null)
            {
                ...
                string filePath = SafeArchivePath.Resolve(extractPath, entry.Name);
