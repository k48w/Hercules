...
namespace Hercules.UI.ViewModels.Settings
{
    ...
    public sealed partial class NewsViewModel : ObservableObject, IDisposable
    {
        ...
        private const string FeedUrl =
            "https://raw.githubusercontent.com/KloBraticc/HerculesNews-/main/news.json";
        ...
        public NewsViewModel()
        {
            ...
            _http.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("Hercules", "1.0"));
