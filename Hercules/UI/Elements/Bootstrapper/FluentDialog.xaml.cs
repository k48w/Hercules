...
using Hercules.UI.ViewModels.Bootstrapper;
using System;
...
namespace Hercules.UI.Elements.Bootstrapper
{
    public partial class FluentDialog : IBootstrapperDialog
    {
        ...
        public Hercules.Bootstrapper? Bootstrapper { get; set; }
        ...
        public FluentDialog(bool aero)
        {
            ...
            .OfType<Hercules.UI.Elements.Settings.MainWindow>()
            .FirstOrDefault();
            if (App.Settings.Prop.BackgroundWindow)
            {
                _mainWindow?.Hide();
            }
            Hercules.UI.Elements.Bootstrapper.AudioPlayerHelper.PlayStartupAudio();
            this.Closed += (s, e) =>
            {
                _mainWindow = System.Windows.Application.Current.Windows
                .OfType<Hercules.UI.Elements.Settings.MainWindow>()
                ...
                Hercules.UI.Elements.Bootstrapper.AudioPlayerHelper.StopAudio();
            };
