...
using Hercules.UI.Elements.Controls;
...
namespace Hercules.UI.Elements.Settings
{
    public partial class MainWindow : INavigationWindow
    {
        ...
        private void OpenToolbox(TabItemViewModel targetTab, MainWindowViewModel vm)
        {
            ...
            CreateToolItem("Background Snow", "Adds Snow to Herculess background (Restart Required)");
        ...
        private void UpdateDiscordPresence()
        {
            ...
            {
                Details = $"Viewing {pageName}", // the fuck was there state I just relized that it already displays fucking hercules THE FUCK
